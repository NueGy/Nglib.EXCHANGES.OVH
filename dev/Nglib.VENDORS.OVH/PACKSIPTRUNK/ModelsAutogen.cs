...
// [GET] "/pack/siptrunk"  string[]--
//[GET] "/pack/siptrunk/{packName}"  pack.siptrunk.PackSipTrunk--packName
//[POST] "/pack/siptrunk/{packName}/changeContact"  long[]--contactAdmin,contactBilling,contactTech,packName
//[GET] "/pack/siptrunk/{packName}/serviceInfos"  services.Service--packName
//[PUT] "/pack/siptrunk/{packName}/serviceInfos"  void--,packName
namespace Nglib.VENDORS.OVH.PACKSIPTRUNK {
	...
	/// </summary>
	public class PacksiptrunkPackSipTrunk {
		
		private string PackName_bfield;
		
		/// <summary>
		/// Name of the SIP trunk pack
		/// {&quot;CanBeNull&quot;:false,&quot;Type&quot;:&quot;string&quot;,&quot;Description&quot;:&quot;Name of the SIP trunk pack&quot;,&quot;Readonly&quot;:true}
		/// </summary>
		[JsonProperty("packName")]
		public string PackName {
			get {
				return this.PackName_bfield;
			}
			set {
				this.PackName_bfield = value;
			}
		}
	}
