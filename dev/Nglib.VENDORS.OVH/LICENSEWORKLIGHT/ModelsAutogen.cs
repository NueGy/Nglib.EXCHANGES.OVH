...
// [GET] "/license/worklight"  string[]--
//[GET] "/license/worklight/orderableVersions"  license.WorkLightOrderConfiguration[]--ip
//[GET] "/license/worklight/{serviceName}"  license.worklight.WorkLight--serviceName
//[PUT] "/license/worklight/{serviceName}"  void--,serviceName
//[GET] "/license/worklight/{serviceName}/allowedDestinationIp"  ipBlock[]--serviceName
//[GET] "/license/worklight/{serviceName}/canLicenseBeMovedTo"  license.ChangeIpStatus--destinationIp,serviceName
//[POST] "/license/worklight/{serviceName}/changeIp"  license.Task--destinationIp,serviceName
//[POST] "/license/worklight/{serviceName}/confirmTermination"  string--commentary,futureUse,reason,serviceName,token
//[GET] "/license/worklight/{serviceName}/serviceInfos"  services.Service--serviceName
//[PUT] "/license/worklight/{serviceName}/serviceInfos"  void--,serviceName
//[GET] "/license/worklight/{serviceName}/tasks"  long[]--action,serviceName,status
//[GET] "/license/worklight/{serviceName}/tasks/{taskId}"  license.Task--serviceName,taskId
//[POST] "/license/worklight/{serviceName}/terminate"  string--serviceName
namespace Nglib.VENDORS.OVH.LICENSEWORKLIGHT {
	...
	/// </summary>
	public enum LicenseWorkLightVersionEnum {
		...
		[EnumMember(Value="worklight-license-version-6-1cpu-1u")]
		Worklight_license_version_6_1cpu_1u,
		
		[EnumMember(Value="worklight-license-version-6-1cpu-2u")]
		Worklight_license_version_6_1cpu_2u,
		
		[EnumMember(Value="worklight-license-version-6-2cpu-1u")]
		Worklight_license_version_6_2cpu_1u,
		
		[EnumMember(Value="worklight-license-version-6-2cpu-2u")]
	...
	/// </summary>
	public class LicenseOrderableWorkLightCompatibilityInfos {
		
		private string Version_bfield;
		
		/// <summary>
		/// 
		/// {&quot;CanBeNull&quot;:false,&quot;Type&quot;:&quot;license.WorkLightVersionEnum&quot;,&quot;Description&quot;:null,&quot;Readonly&quot;:false}
		/// </summary>
	...
	/// </summary>
	public class LicenseWorkLightOrderConfiguration {
		...
		/// <summary>
		/// 
		/// {&quot;CanBeNull&quot;:false,&quot;Type&quot;:&quot;license.OrderableWorkLightCompatibilityInfos[]&quot;,&quot;Description&quot;:null,&quot;Readonly&quot;:false}
		/// </summary>
	...
	/// </summary>
	public class LicenseworklightWorkLight {
		...
		/// {&quot;CanBeNull&quot;:false,&quot;Type&quot;:&quot;license.WorkLightVersionEnum&quot;,&quot;Description&quot;:&quot;This license version&quot;,&quot;Readonly&quot;:true}
		/// </summary>
		[JsonProperty("version")]
		public string Version {
			get {
