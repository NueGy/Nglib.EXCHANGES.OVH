...
// [GET] "/email/pro"  string[]--
//[GET] "/email/pro/{service}"  email.pro.Service--service
//[PUT] "/email/pro/{service}"  void--,service
//[GET] "/email/pro/{service}/account"  string[]--id,primaryEmailAddress,service
//[DELETE] "/email/pro/{service}/account/{email}"  email.pro.Task--email,service
//[GET] "/email/pro/{service}/account/{email}"  email.pro.Account--email,service
//[PUT] "/email/pro/{service}/account/{email}"  void--,email,service
//[GET] "/email/pro/{service}/account/{email}/alias"  string[]--email,service
//[POST] "/email/pro/{service}/account/{email}/alias"  email.pro.Task--alias,email,service
//[DELETE] "/email/pro/{service}/account/{email}/alias/{alias}"  email.pro.Task--alias,email,service
//[GET] "/email/pro/{service}/account/{email}/alias/{alias}"  email.pro.AccountAlias--alias,email,service
//[POST] "/email/pro/{service}/account/{email}/changePassword"  email.pro.Task--email,password,service
//[GET] "/email/pro/{service}/account/{email}/diagnostics"  email.pro.AccountDiagnosis--email,service
//[POST] "/email/pro/{service}/account/{email}/diagnostics"  email.pro.Task--email,password,service
//[GET] "/email/pro/{service}/account/{email}/fullAccess"  long[]--email,service
//[POST] "/email/pro/{service}/account/{email}/fullAccess"  email.pro.Task--allowedAccountId,email,service
//[DELETE] "/email/pro/{service}/account/{email}/fullAccess/{allowedAccountId}"  email.pro.Task--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/fullAccess/{allowedAccountId}"  email.pro.AccountFullAccess--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/sendAs"  long[]--email,service
//[POST] "/email/pro/{service}/account/{email}/sendAs"  email.pro.Task--allowAccountId,email,service
//[DELETE] "/email/pro/{service}/account/{email}/sendAs/{allowedAccountId}"  email.pro.Task--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/sendAs/{allowedAccountId}"  email.pro.AccountSendAs--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/sendOnBehalfTo"  long[]--email,service
//[POST] "/email/pro/{service}/account/{email}/sendOnBehalfTo"  email.pro.Task--allowAccountId,email,service
//[DELETE] "/email/pro/{service}/account/{email}/sendOnBehalfTo/{allowedAccountId}"  email.pro.Task--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/sendOnBehalfTo/{allowedAccountId}"  email.pro.AccountSendOnBehalfTo--allowedAccountId,email,service
//[GET] "/email/pro/{service}/account/{email}/tasks"  long[]--email,service
//[GET] "/email/pro/{service}/account/{email}/tasks/{id}"  email.pro.Task--email,id,service
//[POST] "/email/pro/{service}/account/{email}/terminate"  string--email,service
//[GET] "/email/pro/{service}/billingMigrated"  boolean--service
//[GET] "/email/pro/{service}/billingPlan"  string--service
//[GET] "/email/pro/{service}/domain"  string[]--service,state
//[POST] "/email/pro/{service}/domain"  email.pro.Task--configureAutodiscover,configureMx,mxRelay,name,service,type
//[DELETE] "/email/pro/{service}/domain/{domainName}"  email.pro.Task--domainName,service
//[GET] "/email/pro/{service}/domain/{domainName}"  email.pro.Domain--domainName,service
//[PUT] "/email/pro/{service}/domain/{domainName}"  void--,domainName,service
//[DELETE] "/email/pro/{service}/domain/{domainName}/disclaimer"  email.pro.Task--domainName,service
//[GET] "/email/pro/{service}/domain/{domainName}/disclaimer"  email.pro.disclaimer--domainName,service
//[POST] "/email/pro/{service}/domain/{domainName}/disclaimer"  email.pro.Task--content,domainName,outsideOnly,service
//[PUT] "/email/pro/{service}/domain/{domainName}/disclaimer"  void--,domainName,service
//[GET] "/email/pro/{service}/domain/{domainName}/disclaimerAttribute"  email.pro.DisclaimerAttributeEnum[]--domainName,service
//[GET] "/email/pro/{service}/externalContact"  string[]--displayName,externalEmailAddress,firstName,id,lastName,service
//[POST] "/email/pro/{service}/externalContact"  email.pro.Task--displayName,externalEmailAddress,firstName,hiddenFromGAL,initials,lastName,service
//[DELETE] "/email/pro/{service}/externalContact/{externalEmailAddress}"  email.pro.Task--externalEmailAddress,service
//[GET] "/email/pro/{service}/externalContact/{externalEmailAddress}"  email.pro.ExternalContact--externalEmailAddress,service
//[PUT] "/email/pro/{service}/externalContact/{externalEmailAddress}"  void--,externalEmailAddress,service
//[GET] "/email/pro/{service}/server"  email.pro.Server--service
//[GET] "/email/pro/{service}/serviceInfos"  services.Service--service
//[PUT] "/email/pro/{service}/serviceInfos"  void--,service
//[GET] "/email/pro/{service}/task"  long[]--service
//[GET] "/email/pro/{service}/task/{id}"  email.pro.Task--id,service
//[POST] "/email/pro/{service}/updateFlagsOnAllAccounts"  void--service
namespace Nglib.VENDORS.OVH.EMAILPRO {
	...
	/// Service Offer name
	/// </summary>
	public enum EmailproServiceOfferEnum {
		
		[EnumMember(Value="emailpro")]
		Emailpro,
	}
	...
	/// </summary>
	public class EmailproAccountAlias {
	...
	/// Account Diagnosis
	/// </summary>
	public class EmailproAccountDiagnosis {
	...
	/// </summary>
	public class EmailproAccountFullAccess {
	...
	/// </summary>
	public class EmailproAccountSendAs {
	...
	/// </summary>
	public class EmailproAccountSendOnBehalfTo {
	...
	/// </summary>
	public class EmailproExternalContact {
	...
	public class EmailproService {
		...
		/// <summary>
		/// Type of your offer
		/// {&quot;CanBeNull&quot;:false,&quot;Type&quot;:&quot;email.pro.ServiceOfferEnum&quot;,&quot;Description&quot;:&quot;Type of your offer&quot;,&quot;Readonly&quot;:true}
		/// </summary>
		[JsonProperty("offer")]
		public string Offer {
			get {
